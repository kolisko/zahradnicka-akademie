...
export const professionalChapters: Record<string, ProfessionalChapter> = {
  ...
  mnozeni: {
    ...
    sources: [
      ...
      { title: 'How and When to Divide Perennials', organisation: 'University of Minnesota Extension', url: 'https://extension.umn.edu/planting-and-growing-guides/dividing-perennials', scope: 'indikace, termín a provedení dělení trvalek' },
    ],
  },
